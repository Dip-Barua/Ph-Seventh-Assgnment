...
export default function Banner() {
  return (
    <div className='flex justify-between w-10/12 mx-auto my-16 text-center'>
      <div className="bg-banner w-full rounded-3xl"> 
        ...
        <button className='btn my-12 py-3 rounded-2xl text-Black text-2xl font-extrabold bg-[#E7FE29] border-8 border-black shadow-[0_0_0_4px_#E7FE29] p-2"'>
